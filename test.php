...
$connect->query("INSERT INTO klient(surname, name, otch, telephone, email, original_data) VALUES (?s, ?s, ?s, ?s, ?s, ?s)", 'Рустем1', 'тест ', 'добавление', '79093071969', 'sag@sagrus.ru', 'original_data');
$connect->query("INSERT INTO klient(date, surname, name, otch, telephone, email, original_data) VALUES (?s, ?s, ?s, ?s, ?s, ?s, ?s)", '1983-09-28', 'Рустем2', 'тест ', 'добавление', '79093071969', 'sag@sagrus.ru', 'original_data');
$connect->query("INSERT INTO klient(date, surname, name, otch, telephone, email, original_data) VALUES (?s, ?s, ?s, ?s, ?s, ?s, ?s)", NULL, 'Рустем3', 'тест ', 'добавление', '79093071969', 'sag@sagrus.ru', 'original_data');
