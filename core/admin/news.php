                ...
                <div class="modal-body form-horizontal">
                    <?php if($question || $site_id) { ?>
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-sm-10">
                                <textarea class="form-control" name="text"><?=$question?htmlspecialchars($question['text'], ENT_HTML401):"";?></textarea>
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-sm-10">
                                <textarea class="form-control" name="answer"><?=$question?htmlspecialchars($question['answer'], ENT_HTML401):"";?></textarea>
