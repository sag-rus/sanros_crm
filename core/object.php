...
<div class="form-horizontal panel panel-info edit-object">
	...
	<div class="panel-body">
        ...
        <div class="form-group">
            <label class="col-sm-3 control-label">Популярен в курортном регионе</label>
            <div class="col-sm-9">
                <input type="checkbox" class="form-control"<?php if($row['popular_in_kurort']) { ?> checked<?php } ?> id="popular_in_kurort">
            </div>
        </div>
...
function update_main_data_object($connect){
	...
	$popular_in_kurort = isset($_POST["popular_in_kurort"])?(int)$_POST["popular_in_kurort"]:0;
