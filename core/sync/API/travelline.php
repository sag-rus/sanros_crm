...
function get_booking_data($connect, $data){
	...
	$connect -> query("INSERT INTO `1_vpn_req_log` SET `id`=0, `datetime`=NOW(), `ip`='$_POST[ip]', `action`='get_booking_data', `query`=?s", 'after check_new_update_booking...'.print_r($ret, true));
