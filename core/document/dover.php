...
function naimenovanie($connect, $id_obj, $room = "", $date_z = "", $date_v = "", $days = ""){
    ...
    elseif($id_obj == 34) //Лилия
      $html = "Путёвка в санаторий \"Лилия\"";
	elseif($id_obj == 59) //ян
		$html = "Путевка";
	elseif($id_obj == 4) //балкыш
		$html = "Путевка";
	elseif($id_obj == 31) //лениногорский
		$html = 'Путевка в санаторий "Лениногорский"';
	elseif($id_obj == 15) //джалильский
		$html = 'Путевка в санаторий "Джалильский"';
    ...
    elseif($id_obj == 54)
        $html = "Путевка в санаторий \"Шифалы\"";
	elseif($id_obj == 18)
...
function full_name($connect, $id_obj){
	...
	elseif($id_obj == 31) //лениногорский
		$html = 'Управление социальными объектами ПАО "Татнефть" им.В.Д.Шашина'; // ПАО" Татнефть" им.В.Д.Шашина НГДУ "Лениногорскнефть"
	elseif($id_obj == 15) //Джалильский
		$html = 'Управление социальными объектами ПАО "Татнефть" им.В.Д.Шашина'; // ПАО" Татнефть" им.В.Д.Шашина НГДУ "Джалильнефть"
    elseif($id_obj == 35) //лучезарный
        $html = 'Управление социальными объектами ПАО "Татнефть" им.В.Д.Шашина';
    elseif($id_obj == 54) //шифалы
      $html = 'АО "ТАНЕКО"';
	elseif($id_obj == 60) //янган-тау
