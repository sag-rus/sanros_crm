			...
			<tr>
				...
				<td style="width: 350px; padding: 0px; margin: 0px; vertical-align: top;" valign="top">
					<ul style="margin: 0;">
						...
						<li>справка об эпидемиологическом окружении (справка врача-педиатра или от эпидемиолога об отсутствии контакта ребенка с инфекционными больными по месту жительства, в детском саду или школе).</li>
					</ul>
				</td>
			</tr>
			</table>
