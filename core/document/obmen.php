		...
		<?php if($id_obj != 96 AND $id_obj != 61 AND $id_obj != 62 AND $id_obj != 63 AND $id_obj != 64 AND $id_obj != 71 AND $id_obj != 138 AND $id_obj != 67 AND $reduced != 1){ ?>
			...
			<tr>
				<td style="width: 200px; padding: 0px; margin: 0px; vertical-align: top;">
					<ul style="margin: 0;">
                        <li>справка об отсутствии контакта с больными COVID-19 в течении предшествующих 14 дней, выданная медицинской организацией не позднее, чем за 3 дня до отъезда; можно получить в поликлинике по месту жительства непосредственно перед отправлением в санаторий;</li>
