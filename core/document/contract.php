...
?>
	...
	5.2 Настоящий Договор действует до момента окончания путешествия либо до срока оказания последней услуги, включенной в подтвержденную санаторно-курортную путёвку<?php if($id == 183565) {?>, по 24.06.2026 10-00 (мск)<?}?>.<br />
