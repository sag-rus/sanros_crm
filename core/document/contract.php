...
?>
	...
	<p>4.1. Стоимость санаторно-курортной путёвки на дату заключения настоящего Договора, составляет <?php echo $arr[0]; ?> рублей <?php echo add_null($arr[1]); ?> копеек РФ
		...
		?>
		, скидка составляет <?php echo $sale; ?> рублей РФ (<?php echo $itog_sum_sale; ?>).
		<?php if ($id==125409) echo ' Комиссия банка составляет 1541.90 рублей РФ (одна тысяча пятьсот сорок один рубль 90 копеек). ';?>
