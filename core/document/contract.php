...
?>
	...
	<p>4.1. Стоимость санаторно-курортной путёвки на дату заключения настоящего Договора, составляет <?php echo $arr[0]; ?> рублей <?php echo add_null($arr[1]); ?> копеек РФ
		...
		<br />
	<?php if ($id == 144988) {?>
		4.2 КЛИЕНТ одновременно с подписанием сторонами настоящего Договора вносит в счет оплаты стоимости санаторно-курортной путёвки в кассу или на расчетный счет ФИРМЫ аванс в размере 60000 рублей (Шестидесяти тысяч рублей) до 25 марта 2024 г. и остаток по счету  в размере 60000 рублей (Шестидесяти тысяч рублей) до 20 июня 2024 года.<br>
	<?php } else {?>
