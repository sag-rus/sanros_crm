...
?>
	...
	<p>2.1. Туроператором, являющимся непосредственным исполнителем бронирования санаторно-курортной путёвки, поименованный в п. 1.1 настоящего Договора, является следующее юридическое лицо:<br />
	...
	<strong>Размер финансового обеспечения на 2017 год:</strong> 500 000 рублей (Пятьсот тысяч рублей 00 копеек) до 30.11.2017 г.;<br />
	<strong>Номер, дата и срок действия договора страхования гражданской ответственности за неисполнение или ненадлежащее исполнение обязательств по договору о реализации санаторно-курортной путёвки:</strong><br />Договор страхования № 316/08-2016 от 23.08.2016, срок действия с 01.12.2016 по 30.11.2017г.<br />
	<strong>Наименование, адрес (место нахождения) и почтовый адрес организации, предоставившей финансовое обеспечение:</strong><br /> ООО "Страховая группа "АСКО", 423815, г. Набережные Челны, пр.Вахитова, д. 24.</p>
	...
	3.5. При реализации турпродукта ФИРМА обязана передать КЛИЕНТУ основную информацию о потребительских свойствах санаторно-курортной путёвки и выдать сопроводительные документы, необходимые для реализации услуг, входящих в санаторно-курортную путёвку, КЛИЕНТУ или лицам совершающим путешествие (туристам).<br />
	...
	4.3. При подтверждении бронирования турпродукта туроператором КЛИЕНТ оплачивает в течение 5 рабочих дней с момента подтверждения 100% стоимости санаторно-курортной путёвки, с учетом ранее внесенных авансов.<br />
