...
?>
	...
	<p>4.1. Стоимость санаторно-курортной путёвки на дату заключения настоящего Договора, составляет <?php echo $arr[0]; ?> рублей <?php echo add_null($arr[1]); ?> копеек РФ
        ...
        <?php if($id == 79836) { ?>
            &nbsp;4.1.1. В указанную стоимость входит:
            &nbsp; &nbsp; Миронова Е. А. - 25 200 рублей (двадцать пять тысяч двести рублей 00 копеек)
            &nbsp; &nbsp; Миронов Н. В. - 25 200 рублей (двадцать пять тысяч двести рублей 00 копеек)
            &nbsp; &nbsp; Миронов Ф. Н. - 0 рублей (ноль рублей 00 копеек)
        <?php } ?>
		<?php echo $prepay_str; ?>
		<br />
