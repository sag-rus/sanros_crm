...
?>
	...
	<p>1.1. На условиях и в сроки, установленные настоящим Договором, ФИРМА обязуется реализовать следующий туристский продукт, а КЛИЕНТ обязуется оплатить этот турпродукт:<br /><br />
    ...
    <strong>Размер финансового обеспечения:</strong> 500 000 рублей (Пятьсот тысяч рублей 00 копеек) до 28.02.2027г.;<br />
    ...
    <strong>Наименование, адрес (место нахождения) и почтовый адрес организации, предоставившей финансовое обеспечение:</strong><br /> АО "Страховая компания "Двадцать первый век" Адрес места нахождения:191014, г. Санкт-Петербург, Литейный пр., д.57а, Лит. А.</p>
	...
	3.8. ФИРМА обязана обеспечить предоставление всего комплекса услуг, входящих в туристский продукт, с надлежащим уровнем качества.<br />
	<?php if($id == 157862) { ?>
	...
	4.3. При подтверждении бронирования турпродукта ФИРМОЙ КЛИЕНТ оплачивает в течение 5 рабочих дней с момента подтверждения 100% стоимости туристского продукта, с учетом ранее внесенных авансов.<br />
