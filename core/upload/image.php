...
function upload_image_object_server($connect){
	...
	if($object_row) {
      ...
      if(file_exists($directory."/temp/object-head/images/".$object.".jpg")) {
        ...
        @ftp_put($connect_server,"/price/object/head/".$object.".jpg",$directory."/temp/object-head/images/".$object.".jpg", FTP_BINARY);
        @ftp_chmod($connect_server, 0777, "/price/object/head/".$object.".jpg");        
      }
      ...
      $ftp_folder = "/price/images/object/images/" . $object;
...
function resetObjectImagesCache($connect, int $object_id) {
  ...
  $ftp_folder = "/price/object/images/" . $object_id;
  $ftp_folder_room_base = $ftp_folder.'/rooms';
...
function do_upload_images(&$connect_server, $local_dir, $ftp_dir){
  ...
  @ftp_chmod($connect_server, 0777, $ftp_dir);
  while($file = readdir($folder)){
    if(($file != ".") AND ($file != "..") AND ($file)){
