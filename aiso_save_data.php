...
$connect->query("INSERT 1_aiso_log SET `id`=0, `datetime`=NOW(), `data`=?s", $_POST['data']);
...
//                                  VALUES ('0', '0', '".date('Y-m-d')."', NULL, '0', '0', NULL, '$user_id', NULL, '0', '1', '0', '0.00', '0.00', '0.00', '$user_id', '0.00', '0', '".date('Y-m-d', time() + 86400)."', '0', '1', NULL, NULL, NULL, ?s, NULL, NULL, NULL, '0', NULL, NULL, '".date('Y-m-d', time() + 86400*2)."', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, '21', NULL, NULL, '0', '0', '0', '0', '0', '0', '0', '\'\'', '', '0');", $cmnt);
