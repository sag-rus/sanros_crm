...
$room_types = [];
$room_types[0]['arrival'] = '2024-01-05';
$room_types[0]['departure'] = '2024-01-08';
$room_types[0]['room_type_id'] = 398056;
$room_types[0]['plan_id'] = 169964;
$room_types[0]['count'] = 1; //Тут всегда 1
$room_types[0]['adults'] = 2; //Тут количество взрослых согласно размещения
$room_types[0]['children'] = 0;
$room_types[0]['amount'] = 8800;
